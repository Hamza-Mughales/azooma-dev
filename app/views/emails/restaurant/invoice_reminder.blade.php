                                                        ...
                                                        <table cellpadding="1" cellspacing="0" border="0" width="620" align="center">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" valign="top" style="font-family:Arial, Helvetica, sans-serif;font-size:14px; line-height: 22px;" >
                                                                    We would like to remind you that a sum of 
                                                                    <?php
                                                                    if ($payment_option == 2) {
                                                                        echo $down_payment;
                                                                    } else {
                                                                    ...
                                                                    ?> SAR. remains overdue for the month of <?php echo date("F", strtotime($invoice_date)); ?>.

                                                                    We shall be glad if you will settle the amount immediately. If by any chance you have settled the payment, please ignore this reminder and accept our thanks. You can find the invoice for your order at the end of this message.</td>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <table cellpadding="1" cellspacing="0" border="0" width="620" align="center">
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:10px 0px;" colspan="2"><h3 style="border-bottom:1px solid #000;margin:0;font-size:15px;">Bank Details:</h3></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="2" ></td>
                                                                        </tr>
                                                                        <tr >
                                                                            <td style="font-size:13px;"> All payments by Check should be made to<br />
                                                                                <b style="text-align:left;">Nowayrah Media Establishment</b></td>
                                                                            <td><p style="padding:0;margin:0;font-size:15px;display:inline-block;text-align:right"> الرجاء تحرير الشيكات بإسم فرع <br />
                                                                                    مؤسسة نويرة للدعاية والإعلان</p></td>
                                                                        </tr>
                                                                        <tr >
                                                                            <td colspan="2" style="font-size:12px;" ><strong>Wire Transfer :</strong> <br/>
                                                                                Bank Name   : <b>Saudi British Bank ( Tahalia Branch Jeddah (K.S.A. ) </b><br/>
                                                                                A/C # <b>036-340883-003</b><br/>
                                                                                IBAN : <b>SA 71 4500 00 00 0363 4088 3003</b><br/></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
