                                    ...
                                    <tr align="left"  valign="top">
                                        <td colspan="2" style="padding:20px 30px">
                                            <h1 style="color: #333;font-size:25px;line-height:28px;margin:15px 0;">
                                                Hi <?php echo stripslashes($rest->rest_Name); ?>
                                            </h1>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="640">
                                                <tr>
                                                    <td style="font-size:16px;">
                                                        ...
                                                        ?>
                                                        Commented on <a href="<?php echo URL::to(MRestActions::getRestCity($rest->rest_ID) . '/' . $rest->seo_url); ?>#rest-reviews"><?php echo stripslashes($rest->rest_Name); ?></a> on Azooma.co <br />
                                                        <br />
                                                ...
                                                <tr>
                                                    <td colspan="2" style="font-size:14px;padding-bottom:10px;" > Azooma Team </td>
                                                </tr>                  
                                                <tr>
