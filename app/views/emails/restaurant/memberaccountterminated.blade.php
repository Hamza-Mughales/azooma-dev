                                                        ...
                                                        <table cellpadding="1" cellspacing="0" border="0" width="620" align="center">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" valign="top" style="font-family:Arial, Helvetica, sans-serif;font-size:14px; line-height: 22px;" >
                                                                    We would like to inform you that your account at Sufrati.com has been terminated for technical reasons.<br/>
                                                                    Sufrati.com reserves the right to terminate any account at any time, if it sees any of the following cases:
                                                                    <ul style="line-height:21px;font-size:14px;margin: 0px;">
                                                                        <li> If there has been no user activity/updates for over two months. </li>
                                                                        <li> If you have requested to terminate your account. </li>
                                                                        <li> If there has been mal practice and destructive online activities that may offend or harm Sufrati.com and its users. </li>
                                                                        <li> If your page has had several complaints from users. </li>
                                                                        <li> If your business is found to be nonexistent or closed. </li>
                                                                    </ul>
                                                                </td>
                                                            </tr> 
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; padding-left:10px; padding-right:10px;">
                                                                    If you wish to re-activate your business profile management account, please feel free to contact us through email to <a href="mailto:data@azooma.co" style="color:#00A2B1;">data@azooma.co</a> or call us on <?php echo $country->telephone; ?>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2">&nbsp;</td>
