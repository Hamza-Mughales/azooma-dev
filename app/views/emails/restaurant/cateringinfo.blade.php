                                    ...
                                    <tr>
                                        <td colspan="2" align="left" valign="top">
                                            <a href="<?php echo Azooma::URL(); ?>" title="Sufrati">
                                                <img src="<?php echo Azooma::CDN('stat/sufrati_occasions.jpg'); ?>" width="730" alt="Sufrati" style="outline:none; text-decoration:none; -ms-interpolation-mode: bicubic;border:none;"/>
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" height="100px" valign="top" style="padding:0 30px 20px;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="640">
                                                <tr>
                                                    <td style="font-size:16px;">
                                                        <h1 style="color: black !important;font-size:25px;line-height:30px;">
                                                            <?php
                                                            if (isset($view) && $view) {
                                                                echo 'Hi Restaurant Name';
                                                            } else {
                                                                echo "Hi " . ucwords(stripslashes($restname));
                                                            }
                                                            ?>,
                                                        </h1>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="font-size:16px;">
                                                        <p style="margin:0px 0px;color:#000;font-family:Arial, Helvetica, sans-serif; font-size:14px;line-height: 20px;"> 
                                                            Kindly provide us with the best menu options and rates for the specification of the event below within 24hrs.
                                                        </p>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="font-size:14px;line-height:20px;padding:0px 0px;line-height:21px;"> 
                                                ...
                                                <tr>
                                                    <td colspan="2" style="font-size:14px;padding-bottom:10px;" > Sufrati Occasions Team </td>
                                                </tr>                  
