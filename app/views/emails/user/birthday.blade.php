                        ...
                        <tr>
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0" width="640" >
                                                    ...
                                                    <tr align="left"  valign="top">
                                                        <td colspan="2" style="padding:20px 0px">
                                                            <h1 style="color: #333;font-size:25px;line-height:28px;margin:15px 0;">
                                                                <?php echo "Hi ".stripcslashes($user->user_FullName);?>
                                                            </h1>
                                                        </td>
                                                    </tr>
                                                        <tr>
                                                            <td style="font-size:16px;line-height:20px">
                                                                We wanted to let you know that today, is the best day ever!
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="10"></td>
                                                        ...
                                                        <tr>
                                                            <td style="font-size:16px;line-height:20px">
                                                                "&nbsp;<?php  echo $randommessage->msg;?>&nbsp;"
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td valign="top" width="225">
                                                    <img src="http://uploads.azooma.co/stat/birthdayballoon.jpg" alt="Happy Birthday" style="margin-top:-80px;">   
                                                </td>
                                            </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <?php if(isset($city)&&count($restaurants)>0){ ?>
                                    <tr>
                                        <td colspan="2" height="10" style="height:10px;"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="padding:0 30px;">
                                        <p style="color:#e60683;font-weight:bold;font-size:19px;line-height:20px;margin:10px 0;">Enjoy your day @ one of our recommended venues :</p>
                                        </td>
                                    </tr>
                                    <?php if(isset($city)){ ?>
                                    <tr>
                                        <td colspan="2" style="padding:0 30px;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="640">
                                                ...
                                                foreach ($restaurants as $rest) {
                                                    $restlogo=($rest->rest_Logo!="")?$rest->rest_Logo:"default_logo.gif";
                                                    ?>
                                                    <td width="120" style="margin:10px 15px;width:120px;vertical-align: top;">
                                                        <a href="<?php echo Azooma::URL($city->seo_url.'/'.$rest->seo_url);?>" title="<?php echo stripcslashes($rest->rest_Name);?>">
                                                            <img src="<?php echo Azooma::CDN('logos/'.$restlogo);?>" alt="<?php echo stripcslashes($rest->rest_Name);?>" width="100" height="100" style="padding:5px;border:1px solid #ccc;">
                                                        </a>
                                                        <a href="<?php echo Azooma::URL($city->seo_url.'/'.$rest->seo_url);?>" title="<?php echo stripcslashes($rest->rest_Name);?>" style="margin-top:6px;font-weight:bold;color:#00a2b1;text-decoration:none;">
                                                        <?php echo stripcslashes($rest->rest_Name);?>
                                                        </a>
                                                    </td>
                                                    <?php
                                                }
                                    ...
                                    <?php } } ?>
                                    <tr>
                                        <td colspan="2" height="20" style="height:15px;"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="padding:0 30px;">
                                            <a href="<?php echo Azooma::URL('user/'.$user->user_ID);?>" style="color:#ffffff;font-size:17px;text-decoration:none;width:250px;line-height:47px;background:#00a2b1;padding:8px 15px;border:1px solid #0B9BA8;border-radius:4px;" target="_blank">
                                                <span style="color:#ffffff">
                                                Visit your Sufrati profile
                                                </span>
                                            </a>
