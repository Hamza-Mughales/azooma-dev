                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="640">
                                                <tr>
                                                    <td style="font-size:16px;">
                                                        <?php echo $username;?> invited you to join Azooma
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="vertical-align:top;text-decoration:none;">
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                Hi <?php echo ($invitee->name=="")?'':$invitee->name.' ';?> join Azooma to know more about latest and best restaurants in our city.
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                ...
                                                <tr>
                                                    <td>
                                                       <table>
                                                        <tr>
                                                            <td>
                                                                You can download Azooma on Your phone also 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="https://itunes.apple.com/us/app/Azooma-lite/id709229893?ls=1&mt=8" title="Download Azooma for iOS">
                                                                                <img src="<?php echo Azooma::CDN('stat/appstore-200.jpg');?>" alt="Azooma for iOS" width="200" height="59"/>
                                                                            </a>
                                                                        </td>
                                                                        <td width="5"></td>
                                                                        <td>
                                                                            <a href="https://play.google.com/store/apps/details?id=com.LetsEat.AzoomaLite" title="Download Azooma for Android">
                                                                                <img src="<?php echo Azooma::CDN('stat/googleplay-200.jpg');?>" alt="Azooma for Android" height="59"/>
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
