                                                    ...
                                                    <td style="font-size:16px;">
                                                        <?php if(isset($tosufrati)){ ?>
                                                            <h1 style="color: black !important;font-size:25px;line-height:30px;">
                                                                <a href="<?php echo Azooma::URL('user/'.$user->user_ID); ?>"><?php echo stripcslashes($user->user_FullName);?></a> has made a catering order on Sufrati <?php echo $user->user_Mobile;?>
                                                            </h1>
                                                        <?php }else{ ?>
                                                            <h1 style="color: black !important;font-size:25px;line-height:30px;">
