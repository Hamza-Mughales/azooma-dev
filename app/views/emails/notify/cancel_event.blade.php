                                        ...
                                        <td colspan="2" height="100px" valign="top" style="padding:0 30px 20px;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="640">
                                                    ...
                                                    <td style="font-size:16px;">
                                                        <?php if(isset($tosufrati)){ ?>
                                                            <h1 style="color: black !important;font-size:25px;line-height:30px;">
                                                                Event Cancellation - SUF000<?php echo $event->id; ?>
                                                            </h1>
                                                        <?php }else{ ?>
                                                            <h1 style="color: black !important;font-size:25px;line-height:30px;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php if(isset($tosufrati)){ ?>
                                                        <a href="<?php echo Azooma::URL('user/' . $user->user_ID); ?>"><?php echo $user->user_FullName; ?></a> has cancelled his catering order SUF000<?php echo $event->id; ?> for <?php echo $event->date; ?> please contact <?php echo $user->user_Mobile;?> to confirm.
                                                        <?php }else{ ?>
                                                        This is a notification regarding cancellation of your event (SUF000<?php echo $event->id; ?>) for <?php echo $event->date; ?>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                                <tr>
