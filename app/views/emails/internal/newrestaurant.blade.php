                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="640">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if(Session::has('userid')){
                                                        ?>
                                                        <a href="<?php echo Azooma::URL('user/'.Session::get('userid'));?>" title="<?php echo $your_Name;?>"><?php echo $your_Name;?></a> added a new restaurant <?php echo $rest_Name;?>
                                                        <?php
                                                    }else{
                                                        ?>
                                                        <?php echo $your_Name;?> added a new restaurant <?php echo $rest_Name;?>
                                                    <?php } ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php echo $your_Name.' - '.$your_Position.' has added new restaurant - '.$rest_Name.' for '.$location.' '.$city->city_Name;?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="15">
                                                ...
                                                <tr>
                                                    <td style="font-size:14px;line-height:19px;">
                                                        <p><b>
                                                        ...
                                                        <ul style="font-size:14px;line-height:22px;">
                                                            ...
                                                            <li>
                                                                Activate restaurant profile page
                                                            </li>
                                                            <li>
                                                                Activate trial account 30 days
                                                            </li>
                                                        </ul>
                                                        <p><b>
                                                            Please make sure that you call them to ask about the user experience, if they would like assistance and inform them of our other services.
                                                        </b></p>
                                                        <ul>
                                                            <li>
