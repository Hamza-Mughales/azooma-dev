                                            ...
                                            <table cellpadding="1" cellspacing="1" border="0" width="640">
                                                <tr>
                                                    <td style="font-size:17px;line-height:20px;">
                                                        Branch corrrection request for <a href="<?php echo Azooma::URL($city->seo_url.'/'.$rest->seo_url.'/'.$branch->url);?>" title="<?php echo stripcslashes($rest->rest_Name);?>"><?php echo stripcslashes($rest->rest_Name.' '.$branch->br_loc.' '.$branch->district_Name.' '.$branch->city_Name);?></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="30">
                                                    ...
                                                    <td>
                                                        <table cellpadding="8" cellspacing="0" border="0" width="640">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <b><?php echo $latitude.', '.$longitude;?></b>
                                                                    &nbsp;&nbsp;<a href="http://maps.google.com/?q=<?php echo $latitude;?>,<?php echo $longitude;?>">View in Google Maps</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="200">
