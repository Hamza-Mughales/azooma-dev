...
<body itemscope itemtype="http://schema.org/WebPage" class="<?php if($lang == 'ar'){ echo 'rtl'; } ?>">
    ...
    <div class="container">
            ...
            <div class="sufrati-white-box inner-padding put-border">
                <div class="overflow">
                    <div class="pull-left" id="social-share-list">
                    ...
                    <div class=" pull-right">
                       <a href="javascript:void(0);" class="btn btn-light slide-btn prev-slide" data-total-slides="<?php echo count($slides)+1;?>"><i class="fa fa-chevron-left"></i> <?php echo Lang::get('messages.previous');?></a>
                       <a href="javascript:void(0);" class="btn btn-light slide-btn next-slide" data-total-slides="<?php echo count($slides)+1;?>"><?php echo Lang::get('messages.next');?> <i class="fa fa-chevron-right"></i></a>
                    </div>
                </div>
                ...
                foreach ($slides as $slide) { $i++;
                    ?>
                <div class="article-slide overflow" id="slide<?php echo $i;?>">
                    <div class="hidden-overflow">
                        <div class="pull-left slide-article-desc">
                            <h2>
                                <?php echo ($lang=="en")?stripcslashes($slide->name):stripcslashes(nameAr);?>
                            </h2>
                            <div>
                                <?php echo ($lang=="en")?stripcslashes(preg_replace("/\r\n|\r|\n/", '<br/>', html_entity_decode(stripcslashes($slide->description), 6, "UTF-8"))):stripcslashes(preg_replace("/\r\n|\r|\n/", '<br/>', html_entity_decode(stripcslashes($slide->descriptionAr), 6, "UTF-8")));?>
                            </div>
                        </div>
                        <div class="pull-right slide-article-image">
                            <div class="article-slide-image">
                                <div class="photo-cropper "></div>
                                <div class="photo-container ">
                                    <img itemprop="image" src="<?php echo Azooma::CDN('images/blog/'.$slide->image);?>" alt="<?php echo ($lang=="en")?stripcslashes($slide->name):stripcslashes(nameAr);?>"/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="article-slide overflow" id="slide<?php echo $i;?>">
                <div class="hidden-overflow">
                    <div class="pull-left slide-related">
                        <h3>
                            ...
                            <div class="overflow">
                                ...
                                <form id="add-articlecomment-form" class="form-horizontal" role="form" method="post" action="<?php echo Azooma::URL('add/articlecomment');?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <button class="btn btn-primary btn-lg" type="submit" id="add-comment-article-btn"><?php echo Lang::get('messages.submit');?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
