...
<ol class="breadcrumb">
  ...
  <li><a href="<?= route('adminrestservices'); ?>">Restaurant Features & Services</a></li>  
...
<div class="well-white">
  <article>    
    ...
    <form name="page-form" id="jqValidate" class="form-horizontal" role="form" action="{{ route('adminrestservices/save'); }}" method="post" enctype="multipart/form-data">
