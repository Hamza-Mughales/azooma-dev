...
<ol class="breadcrumb">
  ...
  <li><a href="<?= route('adminreststyle'); ?>">Restaurant Styles</a></li>  
...
<div class="well-white">
  <article>    
    ...
    <form name="page-form" id="jqValidate" class="form-horizontal" role="form" action="{{ route('adminreststyle/save'); }}" method="post" enctype="multipart/form-data">
