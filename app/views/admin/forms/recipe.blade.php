...
<div class="well-white">
    <article>
        <form name="page-form" id="jqValidate" class="form-horizontal" role="form" action="{{ route('adminrecipe/save'); }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="authorName" class="col-md-2 control-label">Author English</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="authorNameAr" class="col-md-2 control-label">Author Name Arabic</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="prepTime" class="col-md-2 control-label">Preparation Time</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="cookingTime" class="col-md-2 control-label">Cooking Time</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="serves" class="col-md-2 control-label">Serves</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="Ingredients" class="col-md-2 control-label">Ingredients</label>
                <div class="col-md-9">
                    <div id="ingredients-box">
                        ...
                        if (isset($ingredients) && count($ingredients) > 0) {
                            ...
                            foreach ($ingredients as $ingredient) {
                                $j++;
                                ?>
                        <div style="" class="clear <?php if ($j != 1) echo 'top'; ?>">
            ...
            <div class="form-group row">
                <label for="image" class="col-md-2 control-label">Article Image<br /><span class="small-font">(490 * 250)</span></label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="imageDesc" class="col-md-2 control-label">Image Description/Copyright</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="short" class="col-md-2 control-label">Recipe Short</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                <label for="shortAr" class="col-md-2 control-label">Recipe Short Arabic</label>
                <div class="col-md-9">
...
<?php } ?>
    ...
    function addmore(){
        var element='<div class="top clear"> #'+counter+' <input class="auto-width form-control " type="text" name="quantity[]" id="quantity'+counter+'" placeholder="Quantity (1 tbsp,1Kg, etc...)" /><input class="auto-width form-control " type="text" name="ingredient[]" id="ingredient'+counter+'" placeholder="Ingredient Name" /><input class="auto-width form-control " type="text" name="quantityAr[]" id="quantityAr'+counter+'" placeholder="Quantity Arabic(1 tbsp,1Kg, etc...)" /><input class="auto-width form-control " type="text" name="ingredientAr[]" id="ingredientAr'+counter+'" placeholder="Ingredient Name Arabic" /></div>';
