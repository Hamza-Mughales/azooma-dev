...
<ol class="breadcrumb">
  ...
  <li><a href="<?= route('adminresttypes'); ?>">Restaurant Types</a></li>  
...
<div class="well-white container">
  <article>    
    ...
    <form name="page-form" id="jqValidate" class="form-horizontal" role="form" action="{{ route('adminresttypes/save'); }}" method="post" enctype="multipart/form-data">
