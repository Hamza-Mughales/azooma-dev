...
<div class="well-white">
    <form name="restMainForm" id="jqValidate" class="form-horizontal" role="form" action="{{ URL::route('adminrestaurants/save'); }}" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <details open>
                <summary> 
                    <span class="span-collaps">General Info</span>
                </summary>
                <div class="row">
            
                    <div class="form-group col-md-6 row">
                        <label class="col-md-4 control-label" for="openning_manner">Status</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group col-md-6 row">
                        <label class="col-md-4 control-label" for="restbusiness_type">Type</label>
                        <div class="col-md-8">
                            <select name="restbusiness_type" id="restbusiness_type" onchange="selectgroup();" class="form-control none-select2 required">
                                <?php
                            ...
                            <select name="group_value" id="group_value" <?php
                                                                        if (!isset($rest) || ($rest->restbusiness_type != "2")) {
                                                                            echo 'class=" form-control hidden none-select2"';
                                                                        } else {
                                                                            echo 'class=" form-control none-select2"';
                                                                        }
                    ...
                    <div class="form-group col-md-6 row">
                        <label class="col-md-4 control-label" for="rest_Name"> Name</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group col-md-6 row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control required" type="text" name="rest_Name_Ar" id="rest_Name_Ar" placeholder="Restaurant Arabic Name" dir="rtl" <?php echo isset($rest) ? 'value="' . stripslashes($rest->rest_Name_Ar) . '"' : ""; ?> />
                        </div>
                    </div>
                    <?php
                    if (isset($rest)) {
                    ...
                    <div class="form-group col-md-6 row">
                        <label class="col-md-4 control-label" for="rest_style"> Style</label>
                        <div class="col-md-8">
            ...
            <details>
                <summary> 
                    <span class="span-collaps">Business / Restaurant Contact Info</span>
                </summary>
                <div class="row">
                    <div class="form-group col-md-6 row">
            ...
            <details>
                <summary> 
                    <span class="span-collaps">Address</span>
                </summary>
                <div class="row">
                    <div class="form-group col-md-6 row">
            ...
            <details>
                <summary> 
                    <span class="span-collaps">Open Hours &amp; Days</span>
                </summary>
                <div class="row">
            ...
            <details>
                <summary> 
                    <span class="span-collaps">About the Restaurant</span>
                </summary>
                <div class="row">
            ...
            <details>
                <summary> 
                    <span class="span-collaps">Contact person Info</span>
                </summary>
                <div class="row">
...
<script>
    ...
    // $('.span-collaps').on('click', function(){
