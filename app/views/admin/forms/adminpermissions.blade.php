                ...
                if($addpos!==false){
                 ...
                 <td>
                   <label class="checkbox inline">
                    <input type="checkbox" name="permissions[]" value="<?php echo $arr->id;?>" <?php if(isset($userpermissions)&&in_array($arr->id,$userpermissions)) echo 'checked="checked"'; ?> <?php if(isset($entry)&&in_array($arr->id,$entry)) echo 'checked="checked"'; ?> /><?php echo $arr->permissionText;?>
                  </label>
                </td>
                <?php
              }
