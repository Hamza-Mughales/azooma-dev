    ...
    <legend>   Filter Results </legend>  
        ...
        <div class="form-group row">
            <div class="offset-lg-2 col-md-6">
                <button type="submit" class="btn btn-primary-gradien" onclick="reloadTable('rest-services')">Filter</button>          
            </div>
        </div>
</div>
...
<div class="well-white">
    <article>    
        <fieldset>
            <legend>
                {{ $pagetitle }}
                <a href="{{ route('adminrestservices/form'); }}" class="btn btn-info btn-sm pull-right">Add new </a>
            </legend>        
        </fieldset>

        <div class="panel table-responsive">
            
            <table class="table table-hover text-center" id="rest-services">
                <thead>
                    <tr>
                        <?php
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        style_table = startDataTable("rest-services","<?= route('adminrestservicesDT') ?>",tab_config);
