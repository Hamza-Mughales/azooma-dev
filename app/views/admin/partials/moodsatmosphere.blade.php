    ...
    <legend>   Filter Results </legend>
        ...
        <div class="form-group row">
            <div class="offset-lg-2 col-md-6">
                <button type="botton" class="btn btn-primary-gradien" onclick="reloadTable('rest-moods')">Filter</button>          
            </div>
        </div>
</div>
...
<div class="well-white">
    <article>    
        <fieldset>
            <legend>
                {{ $pagetitle }}
                <a href="{{ route('adminmoodsatmosphere/form'); }}" class="btn btn-info btn-sm pull-right">Add new </a>
            </legend>        
        </fieldset>

        <div class="panel table-responsive">
            
            <table class="table table-hover text-center" id="rest-moods">
                <thead>
                    <tr>
                        <?php
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        style_table = startDataTable("rest-moods","<?= route('adminmoodsatmosphereDT') ?>",tab_config);
