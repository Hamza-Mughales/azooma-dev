    ...
    <legend> Filter Results </legend>  
        ...
        <div class="form-group row">
            <div class="offset-lg-2 col-md-6">
                <button type="button" class="btn btn-primary-gradien" onclick="reloadTable('rest-offers')">Filter</button>          
            </div>
        </div>
</div>
...
<div class="well-white">
    <article>    
        <fieldset>
            <legend>
                {{ $pagetitle }}
                <a href="{{ route('adminofferscategoires/form'); }}" class="btn btn-info btn-sm pull-right">Add new </a>
            </legend>        
        </fieldset>

        <div class="panel table-responsive">
            
            <table class="table table-hover text-center" id="rest-offers">
                <thead>
                    <tr>
                        <?php
...
<script type="text/javascript">
    ...
    var tab_config= {
        columns:[
            {data:"title", name:'categoryName'},
            {data:"nameAr", name:'categoryNameAr'},
            {data:"createdAt"},
    ...
    $(document).ready(function(){
        ...
        style_table = startDataTable("rest-offers","<?= route('adminofferscategoiresDT') ?>",tab_config);
