...
<div id="filter-main" class="collapse well-white">
    ...
    <form name="admin-form" id="jqValidate" class="form-horizontal" role="form" action="{{ route('adminsponsors'); }}" method="get" >
...
<div class="well-white">
    <article>    
        <fieldset>
            <legend>
                {{ $pagetitle }}
                <a href="{{ route('adminsponsors/form') }}" class="btn btn-info btn-sm pull-right">Add new </a>
            </legend>        
        </fieldset>
                        ...
                        echo 'class="line-through"';
                            ...
                            ?>>
                                ...
                                <td class="sufrati-action">
                                    ...
                                    if ($list->active == 0) {
                                        ?>
                                        <a class="btn btn-xs btn-info mytooltip" href="{{ route('adminsponsors/status/',$list->id) }}" title="Activate "><i data-feather="minus-circle"></i></a>
                                        <?php
                                    } else {
                                        ?>
                                        <a class="btn btn-xs btn-info mytooltip" href="{{ route('adminsponsors/status/',$list->id) }}" title="Deactivate"><i data-feather="plus-circle"></i></a>
                                        <?php
                                    }
                                    ?>
                                    <a onclick="return confirm('Do You Want to Delete?')" class="btn btn-xs btn-danger mytooltip" href="{{ route('adminsponsors/delete/',$list->id) }}" title="Delete"><i data-feather="trash-2"></i></a>
                                </td>
                            </tr>
                            <?php
                        }
