	...
	<div class="Azooma-result-sub-col-2 ">
		...
		<a class="block" href="<?php echo Azooma::URL($city->seo_url.'/offer/'.$offer->id.'#n');?>" title="<?php echo $offername.' '.Lang::get('messages.inplace',array('name'=>$cityname));?>">
            ...
            <span class="photo-container">
            	<img class="Azooma-super-lazy" src="http://uploads.azooma.co/stat/blank.gif" data-original="<?php echo Azooma::CDN('images/offers/'.$offerimage);?>" alt="<?php echo $offername;?>"/>
            </span>
		</a>
		<?php  } ?>
	</div>
