	...
	<div class="Azooma-result-sub-col-1 overflow ">
		...
		<div class="pull-left result-col-logo">
			<a class="rest-logo" href="<?php echo Azooma::URL($city->seo_url.'/hotel/'.$hotel->url.'#n');?>" title="<?php echo $hotelname.' '.Lang::get('messages.inplace',array('name'=>$cityname));?>">
				<img class="Azooma-super-lazy" src="http://uploads.azooma.co/stat/blank.gif" data-original="<?php echo Azooma::CDN('logos/70/'.$hotellogo);?>" />
			</a>
		</div>
	</div>
	<div class="Azooma-result-sub-col-2">
		<a class="block" href="<?php echo Azooma::URL($city->seo_url.'/hotel/'.$hotel->url.'#n');?>" title="<?php echo $hotelname.' '.Lang::get('messages.inplace',array('name'=>$cityname));?>">
            ...
            <span class="photo-container">
            	...
            	<img class="Azooma-super-lazy" src="http://uploads.azooma.co/stat/blank.gif" data-original="<?php echo Azooma::CDN('Gallery/400x/'.$restaurant->coverphoto);?>" alt="<?php echo $hotelname;?>"/>
            	<?php } ?>
            </span>
		</a>
	</div>
