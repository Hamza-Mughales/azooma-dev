            ...
            <tbody>
                ...
                <tr> 
                    ...
                    <td>
                        ...
                        <a class="azooma-backend-actions" href="<?php echo site_url('ar/menus/formpdf/'.$menu['id'].'?rest='.$rest['rest_ID']);?>" rel="tooltip" title="تحرير">
                        <i class="icon icon-edit"></i> تحرير
                    </a><br/>
                    <a class="azooma-backend-actions" href="<?php echo site_url('ar/menus/deletepdf/'.$menu['id']);?>" rel="tooltip" title="حذف" onclick="return confirm('Do You Want to Delete?')">
