          ...
          <tr>
            <td align="center"><table cellpadding="0" cellspacing="0" border="0" width="640" bgcolor="#ffffff">
                ...
                <td><table cellpadding="0" cellspacing="0" border="0" width="640">
                    ...
                    <tr>
                    <td colspan="2" height="100px" valign="top" style="padding:0 30px 20px;"><?php echo $commentUser; ?>
                        Commented on <a href="<?php echo $this->config->item('sa_url').'rest/'.$rest['seo_url']; ?>"><?php echo $rest['rest_Name']; ?></a> on Azooma.co <br />
                        <br />
