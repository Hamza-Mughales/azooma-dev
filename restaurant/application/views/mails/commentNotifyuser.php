          ...
          <tr>
            <td align="center"><table cellpadding="0" cellspacing="0" border="0" width="640" bgcolor="#ffffff">
                ...
                <td><table cellpadding="0" cellspacing="0" border="0" width="640">
                    ...
                    <td colspan="2" style="padding:20px 30px"><h1 style="color: black !important;font-size:25px;"> Hi <?php if($user['user_NickName']!=""){ echo $user['user_NickName']; }else{ echo $user['user_FullName']; } ?>, </h1></td>
                  </tr>
                    <tr>
                    <td colspan="2" height="100px" valign="top" style="padding:0 30px 20px;">Your Comment on <a href="<?php echo $this->config->item('sa_url').'rest/'.$rest['seo_url'];?>"><?php echo $rest['rest_Name']; ?></a> is activate Now on Sufrati.com <br />
                        <br />
                    ...
                    <td width="330" align="left" valign="bottom" style=" padding:20px 30px; "><strong><?php echo $settings['name'];?></strong><br />
                        ...
                        <p> Don't want to be disturbed? <a href="<?php echo $this->config->item('sa_url').'manage/login/'.$user['rand_num']; ?>" target="_blank"> Change your email preference </a> </p>
                        </td>
