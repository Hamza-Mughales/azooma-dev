...
class Request
{
    ...
    {
        $keyword = $this->request->input("columns.$index.search.value") ?$this->request->input("columns.$index.search.value"): '';
    ...
    {
        $keyword = $this->request->input('search.value') ? $this->request->input('search.value'): '';
