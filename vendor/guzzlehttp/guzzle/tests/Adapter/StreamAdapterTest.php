...
class StreamAdapterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDebugAttributeWritesStreamInfoToTempBufferByDefault()
    {
        ...
        $this->assertContains('<http://localhost:8125/> [CONNECT]', $contents);
        $this->assertContains('<http://localhost:8125/> [FILE_SIZE_IS]', $contents);
        $this->assertContains('<http://localhost:8125/> [PROGRESS]', $contents);
    }
    ...
    public function testDebugAttributeWritesStreamInfoToBuffer()
    {
        ...
        $this->assertContains('<http://localhost:8125/> [CONNECT]', $contents);
        $this->assertContains('<http://localhost:8125/> [FILE_SIZE_IS] message: "Content-Length: 8"', $contents);
        $this->assertContains('<http://localhost:8125/> [PROGRESS] bytes_max: "8"', $contents);
        $this->assertContains('<http://localhost:8125/> [MIME_TYPE_IS] message: "text/plain"', $contents);
    }
